...
<?php
$select="SELECT `mainpic1` FROM `sale_photo` WHERE `entry_id`='{$_GET['id']}'";
...
<?php
$se="SELECT `pic2` FROM `sale_photo` WHERE `entry_id`='{$_GET['id']}'";
$se=$object->query($se);
...
<?php
$sel="SELECT `pic3` FROM `sale_photo` WHERE `entry_id`='{$_GET['id']}'";
...
<?php 
if(($pic1 && $pic2 && $pic3)!=""){?>
<h1 style="margin:30px; 0 20px 0"><a href="../admin/admin_home.php"><img src="../images/done.JPG" width="75" height="69" />Click Here if done Uploading Picture</a></h1>
<?php } ?>

<?php 
if(($pic1 && $pic2 && $pic3)==""){?>
<h1><a href="../admin/admin_home.php"><img src="../images/done.JPG" alt="" width="75" height="69" />Click Here if No Picture</a></h1>
<?php }?>

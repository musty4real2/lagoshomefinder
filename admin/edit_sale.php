...
if($_POST['submit']){
	...
	$update="UPDATE `sale` SET `description`='$description', `summary`='$summary', `price`='$price', `add`='$add', `area`='$area', `feature1`='$feature1', `feature2`='$feature2', `feature3`='$feature3', `feature4`='$feature4', `feature5`='$feature5', `type`='$type', `title`='$title' WHERE `id`='$propid' AND `agent_id`='$agid'";

$exe=$object->query($update);

	
	
	header("location:manage_sale.php?id=$entryid&table=rent_photo&agentid=$agid&agent=$agent");
}
?>


<?php
$getrecord="SELECT * FROM `sale` WHERE `id`='{$_GET['propid']}'";

$get=@mysql_query($getrecord) or die(mysql_error());
while($row=mysql_fetch_array($get)){
?>

<form id="search" action="<?php echo $_SERVER['../sale/wizecho_upload/PHP_SELF'];?>" method="post" enctype="multipart/form-data">
...
<input type="hidden" name="agent" value="<?php echo $_GET['agent'];?>" />
  ...
  <tr>
      <td>Title:</td>
      <td><label>
        <input name="title" type="text" id="title" size="65" value="<?php echo $row['title'];?>" />
      </label></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Description:</td>
      <td><label>
        <textarea name="description" id="textarea" cols="45" rows="5"><?php echo $row['description'];?></textarea>
      </label></td>
      <td>Summary:</td>
    ...
    <tr>
      <td>Address</td>
      <td><input type="text" name="add" id="textfield5"  size="65" value="<?php echo $row['add'];?>" /></td>
      <td>Area:</td>
      <td><input type="text" name="area" id="textfield6"  size="60" value="<?php echo $row['area'];?>" /></td>
    </tr>
    <tr>
      <td>Feature 1</td>
      <td><input type="text" name="feature1" id="textfield7"  size="65" value="<?php echo $row['feature1'];?>"/></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Feature 2</td>
      <td><input type="text" name="feature2" id="textfield8" size="65" value="<?php echo $row['feature2'];?>"/></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Feature 3</td>
      <td><input type="text" name="feature3" id="textfield9" size="65" value="<?php echo $row['feature3'];?>"/></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Feature 4</td>
      <td><input type="text" name="feature4" id="textfield10" size="65" value="<?php echo $row['feature4'];?>"/></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Feature 5</td>
      <td><input type="text" name="feature5" id="textfield11" size="65" value="<?php echo $row['feature5'];?>"/></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
